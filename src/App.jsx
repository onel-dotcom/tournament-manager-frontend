  ...
  return (
    <div style={backgroundStyle}>
      ...
      {!isStarted ? (
        ...
        <div style={{ width: '90%', maxWidth: '450px', backgroundColor: 'rgba(255, 255, 255, 0.45)', padding: '40px', borderRadius: '40px', textAlign: 'center', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.3)', backdropFilter: 'blur(15px)', border: '1px solid rgba(255,255,255,0.3)', fontFamily: mainFont }}>
          
          {/* LOGO */}
          <img src="/images/logo.png" alt="Logo" style={{ width: '180px', marginBottom: '10px', mixBlendMode: 'multiply' }} />
          
          <p style={{ color: '#000', fontSize: '0.95rem', lineHeight: '1.6', marginBottom: '35px', fontWeight: '500' }}>
        ...
        <div style={{ width: '95%', maxWidth: '850px', backgroundColor: 'rgba(255, 255, 255, 0.45)', padding: '25px', borderRadius: '25px', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.3)', backdropFilter: 'blur(15px)', border: '1px solid rgba(255, 255, 255, 0.3)', color: '#000' }}>
        ...
        /* 3. VISTA TABELLONE */
        <div style={{ width: '95%', maxWidth: '900px', backgroundColor: 'rgba(255, 255, 255, 0.45)', padding: '25px', borderRadius: '25px', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.3)', backdropFilter: 'blur(15px)', border: '1px solid rgba(255, 255, 255, 0.3)', color: '#000' }}>
          
          <div style={{ textAlign: 'center', marginBottom: '15px' }}>
             <img src="/images/logo.png" alt="Logo" style={{ width: '110px', mixBlendMode: 'multiply' }} />
          </div>

          <button onClick={() => {setActiveTournamentId(null); fetchHistory();}} style={{ cursor: 'pointer', padding: '6px 15px', marginBottom: '15px', borderRadius: '15px', border: '1px solid #999', background: 'white', fontSize: '0.75rem' }}>← Indietro</button>
          <h2 style={{ textAlign: 'center', color: '#1a365d', fontSize: '1.5rem' }}>{tournamentName}</h2>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '30px', gap: '15px' }}>
            <div style={{ flex: 1 }}>
              <h5 style={{ textAlign: 'center', marginBottom: '15px', textTransform: 'uppercase', opacity: '0.7' }}>Quarti</h5>
            ...
            <div style={{ flex: 1 }}>
              <h5 style={{ textAlign: 'center', marginBottom: '15px', textTransform: 'uppercase', opacity: '0.7' }}>Semifinali</h5>
              {matches.filter(m => m.round == 2).map(m => (
                <div key={m.id} style={{ padding: '20px', marginBottom: '20px', borderRadius: '15px', background: 'rgba(255,255,255,0.6)', textAlign: 'center', border: '1px solid rgba(255,255,255,0.4)' }}>
                  <p style={{fontWeight: 'bold', marginBottom: '10px', fontSize: '1.1rem'}}>{m.team1_name || '??'} vs {m.team2_name || '??'}</p>
            ...
            <div style={{ flex: 1.4 }}>
              <h5 style={{ textAlign: 'center', marginBottom: '15px', textTransform: 'uppercase', opacity: '0.7' }}>Finale</h5>
              {matches.filter(m => m.round == 3).map(m => (
                <div key={m.id} style={{ padding: '40px', borderRadius: '30px', background: 'rgba(43, 108, 176, 0.1)', textAlign: 'center', border: '3px solid rgba(43, 108, 176, 0.4)', boxShadow: '0 10px 30px rgba(43,108,176,0.2)' }}>
                  <h3 style={{ fontSize: '1.4rem', marginBottom: '20px' }}>{m.team1_name || '???'} <br/> vs <br/> {m.team2_name || '???'}</h3>
